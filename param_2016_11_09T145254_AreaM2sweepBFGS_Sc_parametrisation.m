...
% 2016-11-09T145254_AreaM2sweepBFGS_Sc_parametrisation 
param.general.passDomBounds = [-0.4,1.4;-0.4,0.4]; 
...
param.general.case = ['optimNACA0012Sc']; 
...
param.snakes.force.distEpsilon = [1e-05]; 
param.snakes.force.dirEpsilon = [1e-05]; 
