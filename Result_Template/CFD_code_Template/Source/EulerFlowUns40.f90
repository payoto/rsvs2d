...
!     INTEGER VARS
     ...
     &  nreal,nrealstop,tstopi,nsurf,rbf_type,irest,dimnum,npercyc,nv
      ...
      real::machinfuse,aoause,aoainc,machinc
      integer::aamax,mmax,aa,mm,OOF
      integer::conflag,ccnt,switch,aeromode,cc
      real::resval,time
      real,dimension(2,2)::Cmat,Mmat,Kmat,invMmat,prodmat,temp,ident,invK
      real,dimension(2,2)::invtemp
      real,dimension(2)::accnp1,accn,velnp1,veln,posnp1,posn,forces
      real,dimension(2)::rhs,accnp1a,cor
      real::gamn,beta,det,massrat,sindex,plun_on_pit,radrot,offset
      real::cubeh_on_pit,cubea_on_pit
      integer::ccmax,airoff
      real::dts,relax,zeta_h,zeta_a,a0,a1,a2,a3,a4,a5,a6,a7
...
!     *****************************************************
     ...
     &  k1,k2,D,m,lam,nstage,vol,LAP)                                           
      ...
      real,intent(inout),dimension(ncell,4)::D
     ...
     &  ,psi01,lam01
      real,intent(inout),dimension(ncell,4)::LAP
      real::s2,s4
...
!     *****************************************************            
     ...
     &  Runiv,machinf,rhoinf,Tinf,gam,aoa)
      ...
      integer,intent(in),dimension(nedge,4)::edge  
      real,intent(inout),dimension(ncell,4)::R
...
!     **********************************************************      
     ...
     &              nedgei,nedgeb,edgei,edgeb)      
      ...
      real,dimension(ncell,4)::R,D,RT,LAP,pdss,pdssdf,pdsssm
...
!     **********************************************************   
     ...
     &          machinc,mmax,aoainc,conflag,resval,aeromode,airoff)
      ...
      real,intent(out)::machinc,aoainc,resval
...
!     *****************************************************
     ...
     &  ,psi01,lam01
      real,intent(inout),dimension(ncell,4)::LAP
      real::s2,s4
      real,intent(inout),dimension(ncell)::pdss,pdssdf,pdsssm
