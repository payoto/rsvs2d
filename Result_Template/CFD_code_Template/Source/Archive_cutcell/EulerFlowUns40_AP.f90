...
300   format("--------------------------------------------------------")
     ...
     &                 momx,momy,cx,cy,cm,resval,conflag)
        ...
        if(res.gt.0.0)then
          ...
          write(501,"(I10 ES24.16E2 ES24.16E2 ES24.16E2 ES24.16E2 ES24.16E2 ES24.16E2)") ccnt,log10(res),cl,cm,cd,cx,cy
          write(401,*) ccnt,log10(res)!,cl,cm,cd,cx,cy
        else
          print *,t,res,cl,cm        
          write(501,"(I10 ES24.16E2 ES24.16E2 ES24.16E2 ES24.16E2 ES24.16E2 ES24.16E2)") ccnt,res,cl,cm,cd,cx,cy
