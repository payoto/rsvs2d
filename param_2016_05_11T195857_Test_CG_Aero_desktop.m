% Parameter File 
% 11-May-2016 19:58:57 
% 2016-05-11T195857_Test_CG_Aero_desktop 

param.general.optimCase = ['Test_CG_Aero_desktop']; 
...
param.general.startPop = ['randuniform']; 
param.general.maxIter = [6]; 
...
param.optim.CG.diffStepSize = [0.01]; 
