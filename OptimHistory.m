...
function [h]=OptimHistory(type,optimstruct,knownOptim,dirOptim)
    
    switch type
        case 'nograd'
            [h]=OptimHistory_nograd(optimstruct,knownOptim,dirOptim);
        case 'grad'
...
function [h]=OptimHistory_nograd(optimstruct,knownOptim,dirOptim)
