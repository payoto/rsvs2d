...
function [snaxel2,snakposition2,sensSnax,volumefraction,sensSnaxRaw]=...
    ...
    sensSnaxRaw(:,find(any(sensSnax~=0)))=sensSnax(:,find(any(sensSnax~=0)))./...
...
function [cellordstruct]=ScaleModeSnakeProp(cellordstruct,cellCentredCoarse,param,diffStepSize)
    ...
    cellOrdSub=(FindObjNum([],[cellordstruct(:).index],cellInd));
