...
% 2016-07-06T185430_Desk_CG_inline_out 

param.general.optimCase = ['Desk_CG_inline_out']; 
...
param.constraint.initVal = {{['.\Active_Build\ConstraintFiles\inline_5b12.png'],['min']}}; 
