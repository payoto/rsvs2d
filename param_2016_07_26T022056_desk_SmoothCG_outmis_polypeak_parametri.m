...
% 2016-07-26T022056_desk_SmoothCG_outmis_polypeak_parametrisation 
param.general.passDomBounds = [-3,3;-3,3]; 
...
param.general.case = ['SupersonicComponent']; 
...
param.optiminit.modeSmoothType = ['polypeaksmooth']; 
