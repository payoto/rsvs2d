...
% 2016-09-23T021059_desk_0012cos 
param.general.optimCase = ['desk_0012cos']; 
...
param.spline.splineCase = ['inversedesign2']; 
...
param.obj.invdes.aeroName = ['0012']; 
param.obj.invdes.profileComp = ['distance']; 
param.constraint.desVarConstr = {}; 
param.constraint.desVarVal = {}; 
param.constraint.resConstr = {['SnakResBarrier']}; 
param.constraint.resVal = {[1]}; 
